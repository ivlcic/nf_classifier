...
from transformers import AutoTokenizer, AutoModelForSequenceClassification, AutoModelForTokenClassification, BatchEncoding, \
...
class TokenClassModelContainer(ModelContainer):
    ...
    def __init__(self, model_dir: str, model_name: str, labeler: nf.Labeler):
        ...
        self.model = AutoModelForTokenClassification.from_pretrained(
            model_name, cache_dir=model_dir, num_labels=len(labeler.label_to_id),
            id2label=labeler.id_to_label, label2id=labeler.label_to_id
        )
